...
<body>
	...
	<main role="main" class="p-4"> <% if (tickets >= capacity) { %>
	<p><%= message %></p>
	<% } else { %>
	<div class="row">
		<div class="col-12">
			<div class="ticket">
				<p>
					整理券番号:
					<%= ticket.getIdentification_code()%></p>
			</div>
			<div class="ticket">
				<p>
					イベント名:
			...
			<div class="ticket">
				<form action="./PrintServlet" method="get">
					<input type="submit" name="print" value="印刷ページへ"
						class="btn btn-secondary"> <input type="hidden"
						name="identification_code"
						value="<%= ticket.getIdentification_code()%>">
				</form>
			</div>
		</div>
	</div>
