...
<% String endNot = (String) request.getAttribute("endNot");  %>
	...
	<div class = "row">
		<div class = "col-6">
			<div class="form-group" style="text-align:center">
				<input type="button" name = "newEvent" onclick = "location.href='./NewEventServlet'"
						class="btn btn-secondary" value="イベント作成">
			</div>
		</div>
		<div class = "col-6">
			<div class="form-group" style="text-align:center">
				<input type="button" name = "searchEvent" onclick = "location.href='./EventSearchServlet'"
					...
					<div class = "row">
						<div class = "col-6">
							<form action="./EventListServlet" method="GET">
								<input type="submit" name="held" class="btn btn-success" value="開催済み">
							</form>
						</div>
						<div class = "col-6">
							<form action="./EventListServlet" method="GET">
								<input type="submit" name="heldNot" class="btn btn-success" value="未開催">
							</form>
						</div>
					</div>
							...
							<tr>
								...
								<td class="text-muted">
									<form action="./EventDetailsServlet" method="get">
										<input type="submit" name="event_details" class="btn btn-secondary" value="詳細">
