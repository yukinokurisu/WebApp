		...
		<div class="row">
		  	<div class="col-4">
				<h6 class="pb-2 mb-0" style="text-align:center">
					...
					<button type="button" class="btn btn-secondary">イベント作成</button>
					</a>
				</h6>
		  	</div>
		  	<div class="col-4">
				<h6 class="pb-2 mb-0" style="text-align:center">
					...
					<button type="button" class="btn btn-secondary">イベント一覧</button>
					</a>
				</h6>
		   	</div>
			<div class="col-4">
				<h6 class="pb-2 mb-0" style="text-align:center">
					...
					<button type="button" class="btn btn-secondary">整理券認証</button>
					</a>
				</h6>
		   </div>
		</div>
