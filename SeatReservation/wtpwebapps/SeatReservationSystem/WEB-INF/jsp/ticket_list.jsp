...
<nav class="navbar navbar-expand-xl navbar-dark bg-dark mt-3 mb-3">
		...
		<div class="form-group">
			<input type="button" onclick = "location.href='./NewticketsServlet'" value="イベント作成"  class="btn btn-secondary">
		</div>
		<div class="form-group">
			<input type="button" onclick = "location.href='./EventSearchServlet'" value="イベント検索"  class="btn btn-secondary">
		</div>
								...
								<td>
									<div class="form-group">
										<form action="./PrintServlet" method="get"  target="_blank">
											...
											<input type="submit" value="再発行" class="btn btn-secondary">
												<!-- 取り消しは後で実装しましょう～ -->

											<input type="submit" name="reissue" value="再発行" class="btn btn-secondary">
								...
								<td>
									<div class="form-group">
										<form action="./TicketsListServlet" method="post"  target="_blank">
											<input type="submit" name ="cancell_issue" value="発行取り消し" class="btn btn-secondary">
											<input type="hidden" name="identification_code" value="<%= ticket.getIdentification_code()%>">
