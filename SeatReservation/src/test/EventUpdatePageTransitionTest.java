...
public class EventUpdatePageTransitionTest {
	  @Test
...
//	    Thread.sleep(5000);  // Let the user actually see something!
	    ...
	    driver.navigate().to("http://localhost:8080/SeatReservationSystem/EventDetailsServlet?event_details=%E8%A9%B3%E7%B4%B0&event_id=25");
	    driver.findElement(By.name("updateEvent")).click();
